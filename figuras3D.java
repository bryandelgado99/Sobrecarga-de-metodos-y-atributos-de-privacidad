public class figuras3D {
    ...
    //Atributos para piramide
    private float altura_piramide;
    ...
    //Atributos para esfera
    private double radio;

    //Constructores-------------------------------------------------------
    //Constructor general

    public figuras3D(float a, double pi, float radio_base_cono, float altura_cono, double base_prisma, double altura_prisma, double profundidad_prisma,
                     float altura_piramide, float base_piramide, float apotema_piramide, int altura_cilindro, int base_cilindro, int radio_cilindro,
                     double radio, float l) {
        this.a = a;
        this.pi = pi;
    ...
    private float area_lateral_cono(){ //Calculo necesario para calcular el area del cono
        double aux = Math.pow(radio_base_cono, 2);
        double aux2= Math.pow(altura_cono, 2);
        double s = Math.sqrt(aux+aux2);
        return (float) (pi*radio_base_cono*s);
    }
    ...
    private float volumen_cono(){ //Volumen Cono
        return (float) ((1/3)*pi*Math.pow(radio_base_cono, 2)*altura_cono);
    }
...
//cubo
    ...
    private float volumen_esfera(){
        return (float) (0.75*pi*Math.pow(radio,3));
    }
